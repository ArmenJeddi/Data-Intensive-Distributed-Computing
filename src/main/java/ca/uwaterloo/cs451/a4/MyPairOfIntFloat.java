 ...
 */
public class MyPairOfIntFloat implements WritableComparable<MyPairOfIntFloat> {
   ...
   */
  public MyPairOfIntFloat(int left, float right) {
    set(left, right);
  }
  ...
  public boolean equals(Object obj) {
    MyPairOfIntFloat pair = (MyPairOfIntFloat) obj;
   ...
   */
  public int compareTo(MyPairOfIntFloat pair) {
   ...
   */
  public MyPairOfIntFloat clone() {
    return new MyPairOfIntFloat(this.leftElement, this.rightElement);
  }

  /** Comparator optimized for <code>MyPairOfIntFloat</code>. */
  public static class Comparator extends WritableComparator {

    /**
     * Creates a new Comparator optimized for <code>MyPairOfIntFloat</code>.
     */
    public Comparator() {
      super(MyPairOfIntFloat.class);
    }
  ...
  static { // register this comparator
    WritableComparator.define(MyPairOfIntFloat.class, new Comparator());
  }
}